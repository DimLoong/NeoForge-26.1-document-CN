...
const config = {
    ...
    url: "https://neoforge-docs-cn.dimloong.workers.dev/",
    ...
    themeConfig:
            ...
            navbar: {
                ...
                items: [
                    ...
                    .concat([
                        ...
                        // 版本切换已移至左侧边栏顶部（见 src/theme/DocSidebar），不再放 navbar。
                        {
                ...
                links: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {
                                label: "官方 Document GitHub仓库",
                                href: "https://github.com/neoforged/documentation"
                            },
                            {
                                label: "非官方翻译 Document GitHub仓库",
                                href: "https://github.com/DimLoong/NeoForge-26.1-document-CN"
                            }
                        ]
                    }
                ],
        ...
        <p>此为非官方翻译版本，仅供学习。原文档 Copyright © ${new Date().getFullYear()}，基于 MIT 许可证，使用 Docusaurus 构建。</p>
        `
            },
            prism: {
                theme: lightTheme,
            ...
            // 线上 Algolia 已移除，改用本地离线全文搜索（见下方 themes 中的
            // @easyops-cn/docusaurus-search-local），支持中文分词、无需外部服务。
        }),
